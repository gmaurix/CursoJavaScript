...
let dato1 = prompt("Desafio Algoritmo simple \n ingresa primer número");
let dato2 = prompt("Desafio Algoritmo simple \n ingresa segundo número");
...
//funcion que devuelve la suma de ambos valores
  ...
  let suma = num1 + num2
  alert(`Desafio algoritmo simple \n La suma es ${suma}`);
  

/* --------------- Desafio Crear Algoritmo con un Condicional --------------- */
let valor = prompt("Desafio Condicional \n Ingresa un valor para evaluar si es número");
if ( isNaN(valor)) {
  alert(`El valore no es número: ${valor} `  );
} else {
